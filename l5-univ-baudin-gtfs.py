#!/usr/bin/env python3
"""
Script pour récupérer les horaires temps réel de la ligne L5
à l'arrêt Baudin en utilisant le flux GTFS-RT
"""
...
def main():
    print("=" * 60)
    print("HORAIRES TEMPS RÉEL - LIGNE L5")
    print("Arrêt: Baudin")
    print("=" * 60)
    
    # IDs GTFS
    route_id = "4-L5"   # Ligne L5
    stop_id = "4-322"   # Arrêt Baudin
